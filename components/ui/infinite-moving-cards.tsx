...
export const InfiniteMovingCards = ({
  ...
  className?: string;
  renderContent: (item: any) => JSX.Element;
}) => {
  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-yellow-400 px-8 py-6 md:w-[450px] "
            style={{
              background:
